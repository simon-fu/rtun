...
use rtun::{
    ...
    proto::{
        open_p2presponse::Open_p2p_rsp, p2pargs::P2p_args, P2PArgs, P2PDtlsArgs, P2PQuicArgs,
        QuicThroughputArgs, ThroughputArgs, WebrtcThroughputArgs,
    },
    switch::invoker_ctrl::{CtrlHandler, CtrlInvoker},
};
...
async fn kick_quic_throughput<H: CtrlHandler>(
    invoker: CtrlInvoker<H>,
    peer_type: u32,
) -> Result<()> {
        ...
        Open_p2p_rsp::Args(mut remote_args) => {
            ...
            spawn_with_name("p2p-throughput", async move {
                ...
                let r = async move {
                    ...
                    let r = timeout(timeout_duration, run_throughput(rd, wr, thrp_args)).await;
